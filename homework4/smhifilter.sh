...
# Select only measurements done in the first day of the month
FILTER_FILTERFILENAME_ONLYFIRST="april_$FILTER_FILTEREDFILENAME"
log "Filtering on only measurements taken in the first day of the month, writing to $CLEANER_FILTERFILENAME_ONLYFIRST"
grep '-01 ' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLYFIRST
